...
class CandleFire(private val latitudeBands: Int = 40, private val longitudeBands: Int = 40, val radius: Float = 1.0f) {
        ...
        init {
            ...
            for (lat in 0..latitudeBands) {
                ...
                for (long in 0..longitudeBands) {
                    ...
                    val y = cosTheta * 3 // Height is 3 times the radius
        ...
        companion object {
            private const val VERTEX_SHADER_CODE = """
                ...
                void main() {
                    ...
                    float waveHeightX = sin(a_Position.x * 10.0 + u_Time) * 0.025; 
                    float waveHeightZ = sin(a_Position.z * 10.0 + u_Time) * 0.025; 
                    ...
                    modPosition.x += waveHeightX;  // Modify the x position
                    modPosition.z += waveHeightZ;  // Modify the z position
